        ...
        <div id="login">
            <div class="row">
                <div class="span4 offset2">
                    <form action="admin-home.html">
                        <fieldset>
                            ...
                            <label for="username">用户名/邮箱：<a class="pull-right" href="register.html">没有账号？</a></label>
                            <input id="username" name="username" class="input" type="text" placeholder="用户名/邮箱">
                            <label for="password">密码：<a class="pull-right" href="register.html">忘记密码？</a></label>
                ...
                <div class="span4 offset1">
                    <h3>需要账号？<a href="register.html">注册一个</a></h3>
                    <ul>
                        <li>创建自己的问卷</li>
                        <li>获取实时的统计</li>
                    </ul>
